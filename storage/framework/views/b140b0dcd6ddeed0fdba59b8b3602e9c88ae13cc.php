        ...
        <form method="POST" action="/missing_person" novalidate class="form-horizontal" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                ...
                                <?php if($errors->has('mis_fname')): ?> <p class="help-block"><?php echo e($errors->first('mis_fname')); ?></p> <?php endif; ?>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                ...
                                <?php if($errors->has('mis_lname')): ?> <p class="help-block"><?php echo e($errors->first('mis_lname')); ?></p> <?php endif; ?>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <div class="radio">
                                    ...
                                    <?php if($errors->has('mis_gender')): ?> <p class="help-block"><?php echo e($errors->first('mis_gender')); ?></p> <?php endif; ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class='input-group date' id='datetimepicker1'>
                                    ...
                                    <?php if($errors->has('missing_date')): ?> <p class="help-block"><?php echo e($errors->first('missing_date')); ?></p> <?php endif; ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                ...
                                <?php if($errors->has('missing_location')): ?> <p class="help-block"><?php echo e($errors->first('missing_location')); ?></p> <?php endif; ?>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                ...
                                <?php if($errors->has('mp_address')): ?> <p class="help-block"><?php echo e($errors->first('mp_address')); ?></p> <?php endif; ?>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                ...
                                <?php if($errors->has('mp_city')): ?> <p class="help-block"><?php echo e($errors->first('mp_city')); ?></p> <?php endif; ?>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                ...
                                <?php if($errors->has('mp_phone')): ?> <p class="help-block"><?php echo e($errors->first('mp_phone')); ?></p> <?php endif; ?>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                ...
                                <?php if($errors->has('mp_occupation')): ?> <p class="help-block"><?php echo e($errors->first('mp_occupation')); ?></p> <?php endif; ?>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                ...
                                <?php if($errors->has('mp_height')): ?> <p class="help-block"><?php echo e($errors->first('mp_height')); ?></p> <?php endif; ?>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                ...
                                <?php if($errors->has('mp_remarks')): ?> <p class="help-block"><?php echo e($errors->first('mp_remarks')); ?></p> <?php endif; ?>
                            </div>
                        </div>
